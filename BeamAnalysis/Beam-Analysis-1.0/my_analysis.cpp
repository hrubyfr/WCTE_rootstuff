...
int main(int argc, char *argv[]) {
    ...
    //name the file
    std::string fileName = "/home/frantisek/Dokumenty/root/BeamAnalysis/Data/events_run0" + std::to_string(runNumber) + "_beamline_newFormat.root";
